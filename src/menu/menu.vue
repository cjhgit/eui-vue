<template>
    <div class="mu-menu" tabindex="0" v-clickoutside="clickoutside" @keydown="handleKeydown"
         :style="{'width': contentWidth}">
        <div ref="list" class="mu-menu-list" :style="{'width': contentWidth, 'max-height': maxHeight + 'px'}"
             :class="menuListClass">
            <slot></slot>
        </div>
    </div>
