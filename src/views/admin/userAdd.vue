            ...
            <div class="admin-form">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" v-model="user.name" name="courseName" v-validate="'required'">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" v-model="user.password" name="password" v-validate="'required'" type="password">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" v-model="user.email" name="email" v-validate="'email'">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" v-model="user.phone" name="phone" v-validate="'required|numeric'">
                            <div v-show="errors.has('phone')" class="help-block is-danger">{{ errors.first('phone') }}</div>
                            <div class="help-block is-danger" v-if="exitPhone && user.phone == exitPhone">手机已存在</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3">备注：</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" v-model="user.note" rows="3" name="note" v-validate="''"></textarea>
                            <div v-show="errors.has('note')" class="help-block is-danger">{{ errors.first('note') }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        methods: {
            save() {
                this.$validator.validateAll().then(() => {
                    this.$http.post(domainUrl + '/admin/createUser', this.user,
                        {
                            headers: {
