            ...
            <div class="admin-form">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" v-model="oldPwd" name="oldPwd" v-validate="'required'" type="password">
                            <div v-show="errors.has('oldPwd')" class="help-block is-danger">{{ errors.first('oldPwd') }}</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3">新密码：</label>
                        <div class="col-sm-9">
                            <input class="form-control" v-model="newPwd" name="newPwd" v-validate="'required'" type="password">
                            <div v-show="errors.has('newPwd')" class="help-block is-danger">{{ errors.first('newPwd') }}</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData() {
                this.$http.get(domainUrl + '/admin/user/' + localStorage.id, {
                    headers: {
            ...
            save() {
                this.$validator.validateAll().then(() => {
                    this.$http.post(domainUrl + '/admin/user/' + this.user.id + '/updatePassword', {
                            oldPass: this.oldPwd,
                            newPass: this.newPwd
                        },
                        {
