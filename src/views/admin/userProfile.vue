            ...
            <div class="container">
                <div class="bread-nav">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">用户账号设置</li>
                    </ol>
                </div>
                <router-link class="btn btn-primary" :to="routeUrl + '/user/password'">修改密码</router-link>
            </div>
        </div>
            ...
            <div class="admin-form">
                <div class="form-horizontal">
                    ...
                    <!--<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" v-model="user.phone" name="phone" v-validate="'required'">
        ...
        methods: {
            ...
            save() {
                this.$validator.validateAll().then(() => {
                    this.$http.post(domainUrl + '/admin/user/' + this.user.id + '/updateName', {
