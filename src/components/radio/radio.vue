<template>
    <label @mousedown="handleMouseDown" @mouseleave="handleMouseLeave" @mouseup="handleMouseUp"
        ...
        <input type="radio" :disabled="disabled" :name="name" :value="nativeValue" @change="handleChange"
               v-model="inputValue">
        <touch-ripple v-if="!disabled" rippleWrapperClass="mu-radio-ripple-wrapper" class="mu-radio-wrapper">
            ...
            <div class="mu-radio-icon">
                <svg class="mu-radio-icon-uncheck mu-radio-svg-icon" :class="iconClass" v-if="!checkedIcon"
                     viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/>
                </svg>
                <svg class="mu-radio-icon-checked mu-radio-svg-icon" :class="iconClass" v-if="!uncheckIcon"
                     viewBox="0 0 24 24">
