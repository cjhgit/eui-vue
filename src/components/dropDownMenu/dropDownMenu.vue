<template>
    <div class="mu-dropDown-menu" :class="{'disabled': disabled}">
        ...
        <popover v-if="!disabled && $slots && $slots.default && $slots.default.length > 0" :scroller="scroller"
                 :open="openMenu" :trigger="trigger" :anchorOrigin="anchorOrigin" @close="handleClose">
