<template>
    <div>
        <abstract-button @click="handleClick" containerElement="div"
                         :href="href" :disabled="disabled" :disableFocusRipple="disableRipple"
                         :disableTouchRipple="disableRipple" :target="target"
                         ...
                         class="mu-item-wrapper" :wrapperStyle="itemStyle" :style="disabled ? itemStyle : {}"
                         :centerRipple="false">
            <div :class="itemClass">
                ...
                <div class="mu-item-right" v-if="showRight">
                    <icon-button @click.stop="handleToggleNested" @mousedown.native="stop" @touchstart.native="stop"
                                 v-if="toggleNested">
        ...
        <expand-transition>
            <mu-list v-if="showNested" :class="nestedListClass" :nestedLevel="nestedLevel" @change="handleNestedChange"
